	                                    ...
	                                    <tbody>
	                                       <tr>
	                                          <td align="center" valign="middle" style="text-align: center; padding-top: 15px; padding-bottom:10px;border-bottom: 1px solid #ddd;">
	                                             <p style="margin-bottom: 0; margin-top: 0;"><a href="{{url('/')}}"><img src="{{asset('public/frontend')}}/images/logo.png" alt="kroykari.com" width="170" style="border: none; display: inline; font-weight: bold; height: auto; outline: none; text-decoration: none; text-transform: capitalize; font-size: 14px; line-height: 25px; width: 100%; max-width: 170px;"></a></p>
	                                          </td>
	                                       </tr>
	                                    </tbody>
	                                 </table>
	                                             ...
	                                             <tr>
	                                                <td valign="top" style="padding: 0px 48px 0; padding-left: 20px; padding-right: 20px;">
	                                                   <div id="body_content_inner" style="color: #3d3d3d; text-align: left; font-size: 14px; line-height: 25px; font-family: &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, sans-serif; font-weight: 400;">
	                                                      ...
	                                                      <div style="clear: both; height: 1px;"><p>{{__('Your forgot password otp is') }} &nbsp; {{$otp}} , {{__('validate for 15 mins')}}</p></div>
	                                                      <div style="clear: both; height: 1px;"><p>{{__('Please never share this otp to anyone') }}</p></div>
	                                                    </div>  
