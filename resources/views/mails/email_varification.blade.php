	      ...
	      <tbody>
	         <tr>
	            <td align="center" valign="top">
	               <table border="0" cellpadding="0" cellspacing="0" width="600" id="template_container" style="background-color: #ffffff; overflow: hidden; border-style: solid; max-width: 660px; border-top-width: 5px; border-bottom-width: 5px; border-color: #132a5b; border-radius: 0px; border-right: 0px solid #ffffff; border-left: 0px solid #ffffff; box-shadow: 0 1px 20px 5px rgba(0,0,0,0.1); width: 100%; min-width: 320px;">
	                  <tbody>
	                     <tr>
	                        <td align="center" valign="top">
	                                    ...
	                                    <tbody>
	                                       <tr>
	                                          <td align="center" valign="middle" style="text-align: center; padding-top: 15px; padding-bottom:10px;border-bottom: 1px solid #ddd;">
	                                             <p style="margin-bottom: 0; margin-top: 0;"><a href="http://dev.codemeg.com/sos"><img src="{{asset('public/frontend')}}/images/logo.png" alt="Please Help Me Logo" width="170" style="border: none; display: inline; font-weight: bold; height: auto; outline: none; text-decoration: none; text-transform: capitalize; font-size: 14px; line-height: 25px; width: 100%; max-width: 170px;"></a></p>
	                                          </td>
	                                       </tr>
	                                    </tbody>
	                                 </table>
	                                             ...
	                                             <tr>
	                                                <td valign="top" style="padding: 0px 48px 0; padding-left: 20px; padding-right: 20px;">
	                                                   <div id="body_content_inner" style="color: #3d3d3d; text-align: left; font-size: 14px; line-height: 25px; font-family: &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, sans-serif; font-weight: 400;">
	                                                      <p style="margin: 0;">{{__('Hello')}}, {{ucfirst($name)}}!</p>
	                                                      <p style="margin: 0;">{{__('Congratulations now you are a member of our community.')}}</p>
	                                                      <p style="margin: 0; padding: 10px 0 40px">{{__('Please click below button to verify your email.')}}</p>
	                                                    ...
	                                                    <div id="body_content_inner" style="color: #3d3d3d; text-align: left; font-size: 14px; line-height: 25px; font-family: &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, sans-serif; font-weight: 400;text-align: center;">
	                                                     	<a href="{{$url}}" style="font-family: Avenir,Helvetica,sans-serif; box-sizing: border-box;   border-radius: 3px; color: #fff; display: inline-block; text-decoration: none;   background-color: #132a5b; border-top: 10px solid #132a5b; border-right: 50px solid #132a5b;border-bottom: 10px solid #132a5b;border-left: 50px solid #132a5b;font-size: 16px">{{__('Click To Verify')}}</a>
	                                                      <div style="clear: both; height: 20px;"></div>
	                                                      
	                                                   </div>
	                                                   <div id="body_content_inner" style="color: #3d3d3d; text-align: left; font-size: 14px; line-height: 25px; font-family: &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, sans-serif; font-weight: 400;">
	                                                      <p style="margin: 0; padding: 20px 0 30px">{{__('You can not use all features  until you verify your email.')}}</p>
	                                                      <div style="clear: both; height: 1px;"></div>
	                                                    </div>
